...
public:
    ...
    void testmax(Int_t win, Float_t *TempTotChrgPos,Float_t *TempTotChrgNeg);
...
private:
    ...
    Float_t fPileSPD;//
    Float_t fEvtq1Cor;
    Float_t fEvtq1CorPos;
    Float_t fEvtq1CorNeg;
    Float_t fEvtq2Cor;
    ...
    Float_t sinC;
    Float_t fmEvtq1Cor;
    Float_t fmEvtq1CorPos;
    Float_t fmEvtq1CorNeg;
    Float_t fmEvtq2Cor;
    Float_t fmEvtq2CorPos;
    Float_t fmEvtq2CorNeg;
    Float_t fmEvtq3Cor;
    Float_t fmEvtq3CorPos;
    Float_t fmEvtq3CorNeg;
    Float_t fmEvtq3CorUnNPP;
    Float_t fmEvtq3CorUnPNN;
    Float_t fmEvtq4Cor;
    Float_t fmEvtq4CorPos;
    Float_t fmEvtq4CorNeg;
    Float_t mcosC;
    Float_t msinC;
    Int_t fmmaxpos;
    Float_t fmDBValue90Old;
    Int_t maxpos;
    Float_t frpmax;
    Int_t fmaxpos;
    Float_t rpmax;
    Float_t fDBValue90Old;
    Float_t dbOld;
    Int_t   maxp;
    Int_t   maxn;
    Int_t   minp;
